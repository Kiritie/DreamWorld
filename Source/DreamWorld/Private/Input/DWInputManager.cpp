...
void UDWInputManager::PrevInventorySlot()
{
	...
	if(!PlayerCharacter || !PlayerCharacter->IsActive() || UInputModuleStatics::GetKeyShortcut(GameplayTags::Input_CameraZoom).IsPressing(UCommonStatics::GetPlayerController())) return;
