...
UDWCharacterAttackPointComponent::UDWCharacterAttackPointComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}

bool UDWCharacterAttackPointComponent::CanHitTarget_Implementation(AActor* InTarget)
{
	return Super::CanHitTarget_Implementation(InTarget);
}

void UDWCharacterAttackPointComponent::OnHitTarget_Implementation(AActor* InTarget, const FHitResult& InHitResult)
{
...
void UDWCharacterAttackPointComponent::ClearHitTargets_Implementation()
{
	Super::ClearHitTargets_Implementation();
}

void UDWCharacterAttackPointComponent::SetHitAble_Implementation(bool bValue)
{
