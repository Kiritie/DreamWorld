...
#include "WidgetTeamMateHeadBox.generated.h"

/**
 * ��ɫѪ��
 */
UCLASS()
class DREAMWORLD_API UWidgetTeamMateHeadBox : public USubWidgetBase
{
	GENERATED_BODY()

public:
	UWidgetTeamMateHeadBox(const FObjectInitializer& ObjectInitializer);
