...
#include "DWPlayerCharacterState_Aim.generated.h"

/**
 * 
 */
UCLASS()
class DREAMWORLD_API UDWPlayerCharacterState_Aim : public UDWCharacterState_Aim
{
	GENERATED_BODY()
